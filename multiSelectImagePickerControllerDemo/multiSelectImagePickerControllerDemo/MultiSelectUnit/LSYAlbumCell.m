...
-(UIImageView *)statusView
{
    if (!_statusView) {
        ...
        [_statusView setImage:[UIImage imageNamed:@"photo_unselected"]];
    }
    return _statusView;
}
...
-(void)setModel:(LSYAlbumModel *)model
{
    ...
    //NSLog(@"model:select:%d",model.isSelect);
    if(model.isSelect){
      [self.statusView setImage:[UIImage imageNamed:@"photo_selected"]];
    }else{
      [self.statusView setImage:[UIImage imageNamed:@"photo_unselected"]];
    }
}
