...
{
    LSYAlbumCatalogCell *cell = [tableView dequeueReusableCellWithIdentifier:@"albumCatalogCellIdentifer"];
    if (cell == nil) {
        cell = [[LSYAlbumCatalogCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:@"albumCatalogCellIdentifer"];
